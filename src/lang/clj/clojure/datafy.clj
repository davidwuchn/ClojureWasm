...
;;   this software.
;;
;;   clojure.datafy — by Rich Hickey. Reproduced in ClojureWasm with one no-JVM
;;   adaptation (the top-level `(set! *warn-on-reflection* true)` dropped — a cljw
;;   no-op, D-477); the Datafiable extend over IRef/Namespace/Throwable/Class
;;   rides D-478; redistributed under EPL-2.0 per EPL-1.0 §7. ClojureWasm changes
;;   (c) the ClojureWasm authors.
