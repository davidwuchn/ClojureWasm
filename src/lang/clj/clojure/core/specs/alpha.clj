...
;;   this software.
;;
;;   clojure.core.specs.alpha — by Rich Hickey. Reproduced verbatim in ClojureWasm
;;   (specs for clojure.core macros — no adaptations); redistributed under EPL-2.0
;;   per EPL-1.0 §7. ClojureWasm changes (c) the ClojureWasm authors.
