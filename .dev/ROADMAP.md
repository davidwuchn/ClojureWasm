...
| 6.16 | Tier A clojure.core type-predicate cluster: 23 primitives in `lang/primitive/core.zig` (string? / integer? / number? / symbol? / keyword? / vector? / list? / map? / set? / fn? / boolean? / char? / float? / ratio? / decimal? / some? / not / coll? / seq? / sequential? / associative? / identity / boolean). Single-tag-test idiom; underpins clojure.string and most clojure.core callers that pattern-match on type | [x] (`4a9b6c0`)        |
