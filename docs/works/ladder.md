...
| 4    | clojure.data.priority-map  | master        | 1           | fails      | D-275 slice 1 DONE (Object/toString recognised, 97e42e78; past line 266). Next blocker = the `clojure.lang.*` supertype family it declares (ILookup/IPersistentMap/IPersistentStack/Reversible/Sorted/IHashEq/IFn/IObj + MapEquivalence/Serializable markers) → scoped D-280, with D-279 (deftype method arity-overload) as prerequisite. Closed set materialized in host_interfaces.yaml. |
